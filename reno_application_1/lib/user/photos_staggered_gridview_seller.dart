...
class Photos_staggered_gridview_seller extends StatelessWidget {
  final photosList = Photo_seller.generateImages();
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StaggeredGridView.countBuilder(
        ...
        crossAxisCount: 4,
        itemBuilder: (context, index) => Photo_item_seller(photosList[index]),
