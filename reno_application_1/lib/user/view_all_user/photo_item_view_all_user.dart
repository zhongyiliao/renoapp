...
class Photo_view_all_user extends StatelessWidget {
  final Photo_view_all photo_view_all;
  Photo_view_all_user(this.photo_view_all);
  @override
  Widget build(BuildContext context) {
    return Container(
      alignment: Alignment.bottomLeft,
      height: photo_view_all.height,
      width: 240,
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(10),
                  image: DecorationImage(
                    image: AssetImage(photo_view_all.imageUrl),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
