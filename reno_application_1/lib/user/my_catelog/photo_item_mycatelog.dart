...
class Photo_item_mycatelog extends StatelessWidget {
  final Photo_mycatelog photo_mycatelog;
  Photo_item_mycatelog(this.photo_mycatelog);
  @override
  Widget build(BuildContext context) {
    return Container(
      alignment: Alignment.bottomLeft,
      height: photo_mycatelog.height,
      width: 250,
      decoration: BoxDecoration(
        color: getColorFromHex('#F7F7F7'),
        image: DecorationImage(
          image: AssetImage(photo_mycatelog.imageUrl),
          fit: BoxFit.fill,
        ),
