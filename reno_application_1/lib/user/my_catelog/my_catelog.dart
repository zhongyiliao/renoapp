...
class My_catelog extends StatefulWidget {
  @override
  State<My_catelog> createState() => _My_catelogState();
}

class _My_catelogState extends State<My_catelog> {
  Widget _Profilearea() {
    return Column(
      children: [
        Row(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Photos_staggered_gridview_mycatelog(),
          ],
        ),
      ),
    );
